        ...
        if (dotgod) {
            ...
            if (this.isHovering(mouseX, mouseY) && Mouse.isButtonDown(0)) {
                RenderUtil.drawHGradientRect(
                        ...
                        ColorUtil.pulseColor(new Color(me.mioclient.mod.modules.impl.client.ClickGui.INSTANCE.color.getValue().getRed(), me.mioclient.mod.modules.impl.client.ClickGui.INSTANCE.color.getValue().getGreen(), me.mioclient.mod.modules.impl.client.ClickGui.INSTANCE.color.getValue().getBlue(), 200), 50, 1).getRGB(),
                        ColorUtil.pulseColor(new Color(me.mioclient.mod.modules.impl.client.ClickGui.INSTANCE.color.getValue().getRed(), me.mioclient.mod.modules.impl.client.ClickGui.INSTANCE.color.getValue().getGreen(), me.mioclient.mod.modules.impl.client.ClickGui.INSTANCE.color.getValue().getBlue(), 200), 50, 1000).getRGB()
                );
            } else {
                RenderUtil.drawRect(
                        this.x,
